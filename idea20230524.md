...
nohup java -agentlib:jdwp=transport=dt_socket,server=y,suspend=n,address=50005 -jar "$jar_path" -Xmx=4g -Xms=4g -Xmn=3g --spring.profiles.active=prod > "$log_file" 2>&1 &
